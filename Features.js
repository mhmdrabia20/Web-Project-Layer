...
require([
  ...
  `,
    ...
    var featuresugbus = new FeatureLayer({
        url: "https://services8.arcgis.com/KoIzcsvMfmaIZSW9/ArcGIS/rest/services/Alexandria_Touristic_Map_WFL1/FeatureServer/8",

        visible: false,
    });
    var featurestopbus2 = new FeatureLayer({
        url: "https://services8.arcgis.com/KoIzcsvMfmaIZSW9/ArcGIS/rest/services/Alexandria_Touristic_Map_WFL1/FeatureServer/7",
    ...
    var featureLineMN = new FeatureLayer({
        url: "https://services8.arcgis.com/KoIzcsvMfmaIZSW9/ArcGIS/rest/services/Alexandria_Touristic_Map_WFL1/FeatureServer/16",
